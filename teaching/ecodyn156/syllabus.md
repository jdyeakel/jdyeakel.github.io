...
title: "Ecological Dynamics BIO/ESS 156, QSB/ES 256 (Spring, 2026)"
tags: [about, Jekyll, theme, responsive]
modified: 2014-08-08T20:53:07.573882-04:00
comments: true
---

[< Back to Course Page]({{ site.url }}/teaching/ecodyn156)  
[> To Course Schedule]({{ site.url }}/teaching/ecodyn156/schedule/)
...
1. This course is structured as follows: 2x 1 hour and 15 minute lectures per week. Lectures will be interactive, involving both formal lecturing, discussions, and group exploration.  
2. Generally there will be weekly problem sets and/or short coding projects, both in-class and take-home.  
3. There will be unannounced scantron-based quizzes throughout the course (see Required Materials below).  
4. There will be three mid-term exams and a final.  
5. Graduate students in enrolled in QSB/ES 256: there will be a final project that will involve original research using tools from the class.  

---  

## IV. Course Requirements & Grading Procedures  {#requirements}
...
<div style="clear: both;">
    <img src="/images/ottoday.jpeg" style="float: right; width: 200px; margin-left: 20px;">
</div>  

### b. Required and Supplemental Readings  
Required Textbook:  
Otto & Day, *A Biologist's Guide to Mathematical Modeling*   
Other required readings will be provided on the [course schedule]({{ site.url }}/teaching/ecodyn156/schedule/).  
...
- A pack of <a class="hover-tooltip" href="/images/scantron.jpg" target="_blank" rel="noopener">scantrons<img src="/images/scantron.jpg" alt="Scantron form"></a>. A scantron may be needed at *any* time in the course.  
...
<br>
a. Each student in this course is expected to abide by the University of California, Merced’s [Academic Honesty Policy](https://osrr.ucmerced.edu/academic-integrity). Any work submitted by a student in this course for academic credit will be the student's own work or clearly identified group work.  
...
## VII. AI Use Policy  {#ai-use-policy}
...
Please note that the Instructor reserves the right to change the schedule. You will be advised in advance of any changes via email or the UC web system.  

### Lecture schedule (BIO/ESS 156; also used as the core lecture sequence for QSB/ES 256)  

| Week | Topic | Description/Learning Outcomes | Readings | Assessments |  
|---:|---|---|---|---|  
| 1 | Introduction to Theoretical ecology | The role of models in ecology: from theory to data | TBA |  |  
| 1 | Introduction to population dynamics | Population growth models; continuous vs. discrete; arithmetic vs. geometric population growth; doubling time | TBA |  |  
| 2 | Population dynamics I | Logistic population growth; Continuous solutions and carrying capacity; Discrete time: Cob-web diagrams and steady states | TBA | Homework 1 due |  
| 2 | Population dynamics II | More cob-webs: Cycles and Chaos; A bit about bifurcations; Recruitment dynamics as an illustrative guide | TBA |  |  
| 3 | Harvest dynamics | Constant vs. changing effort; Sustainability (MSY and MNP concepts) | TBA | Homework 2 due |  
| 3 | Bioeconomics | Discounting and all that | TBA |  |  
| 4 | Competition I | Lotka-Volterra competition model; Phase planes: saddles and cycles; | TBA | Homework 3 due |  
| 4 | Competition II | Review of LV competition model; The Jacobian matrix: Determinants, Traces, and cyclicity | TBA |  |  
| 5 | Predation I | The Lotka-Volterra predation model; phase planes, stable limit cycles; Prey & predator functional/numerical responses | TBA | Homework 4 due |  
| 5 | Predation II | Dynamic consequences of linear vs. nonlinear functional response; Dynamical implications of generalization/specialization; Holt apparent competition model | TBA |  |  
| 6 | Perturbation Methods I | Linear stability analysis in continuous systems | TBA | Homework 5 due |  
| 6 | Perturbation Methods II | Linear stability analysis in discrete systems | TBA |  |  
| 7 | Exam I | Good Luck! | TBA |  |  
| 7 | Generalized Modeling I | Learning a lot from a little: Chinese dynasties | TBA |  |  
| 8 | Generalized Modeling II | Learning even more from a little: revisiting recruitment & predation | TBA | Homework 6 due |  
| 8 | Dynamics of life history I | Growth, maturity, and reproduction; Leslie matrices | TBA |  |  
| 9 | Dynamics of life history II | Estimating the mean growth rate; r vs. k selection; tradeoffs in growth vs. reproduction | TBA | Homework 7 due |  
| 9 | Planetary carrying capacities I | Human population dynamics | TBA |  |  
| 10 | Planetary carrying capacities II | The dynamics of resource depletion and innovation | TBA | Homework 8 due |  
| 10 | Introduction to probability I | Introduction; Beastiary of distributions; Examples | TBA |  |  
| 11 | Introduction to probability II | Sources of error in population models | TBA | Final project summaries due |  
| 11 | Stochastic population models I | The gambler’s ruin | TBA |  |  
| 12 | Stochastic population models II | Ornstein-Uhlenbeck processes and the inevitability of extinction | TBA | Homework 9 due |  
| 12 | Diet and foraging I | Fitness tradeoffs and diet selection; Gambling: risk and rewards; Marginal Value Theorem | TBA |  |  
| 13 | Diet and foraging II | Fitness-maximization and decision-making I | TBA | Homework 10 due |  
| 13 | Diet and foraging III | Fitness-maximization and decision-making II | TBA |  |  
| 14 | Exam II | Good Luck! | TBA |  |  
| 14 | Introduction to networks I | Size; Statistics; Scales; Structure | TBA |  |  
| 15 | Introduction to networks II | Network dynamics in ecology: Interaction webs | TBA |  |  
| 15 | Introduction to networks III | Network dynamics in ecology: Metapopulations | TBA |  |  
| 16 | Project preparation | Individual working groups |  |  |  
| 16 | Project preparation | Individual working groups |  |  |  
| 17 | FINAL “EXAM” | The UC-Merced Theoretical Ecology Symposium |  | Final project report due |  

### Discussion schedule (QSB/ES 256) — discussion is required for graduate students; undergraduate students are welcome but not required  

| Week | Component | Topic | Readings | Assessments |  
|---:|---|---|---|---|  
| 1 | Discussion | None - organizational |  |  |  
| 2 | Discussion | Population dynamics in R | Peer-reviewed publication TBA |  |  
| 3 | Discussion | Harvest equations in R | Peer-reviewed publication TBA |  |  
| 4 | Discussion | Competition models in R | Peer-reviewed publication TBA |  |  
| 5 | Discussion | Predation models in R | Peer-reviewed publication TBA |  |  
| 6 | Discussion | Linear stability analysis in R | Peer-reviewed publication TBA |  |  
| 7 | Discussion | Generalized modeling in R | Peer-reviewed publication TBA |  |  
| 8 | Discussion | Life history matrices in R | Peer-reviewed publication TBA |  |  
| 9 | Discussion | Coupled human-ecosystems in R | Peer-reviewed publication TBA |  |  
| 10 | Discussion | Probability in R | Peer-reviewed publication TBA |  |  
| 11 | Discussion | Stochastic population models in R | Peer-reviewed publication TBA |  |  
| 12 | Discussion | Diet models in R | Peer-reviewed publication TBA |  |  
| 13 | Discussion | Fitness maximization in R | Peer-reviewed publication TBA |  |  
| 14 | Discussion |  | Peer-reviewed publication TBA |  |  
| 15 | Discussion | Networks in R | Peer-reviewed publication TBA |  |  
| 16 | Discussion | Individual projects | Individual projects |  |  
 -->
