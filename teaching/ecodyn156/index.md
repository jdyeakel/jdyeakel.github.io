...
title: "Ecological Dynamics (Spring, 2026)"
tags: [about, Jekyll, theme, responsive]
modified: 2014-08-08T20:53:07.573882-04:00
comments: true
image:
  feature: aspens_trim.jpeg
  credit:
---
...
This course requires the use of a textbook (Otto and Day, *A Biologist's Guide to Mathematical Modeling*), and assessments will be comprised of both in-class pencil-and-paper work, as well as take-home assignments. AI-use will be integrated into some parts of class assignments, and will be prohibited in others. Quizzes and exams will be taken in class using scantron. ***You will be required to have a pack of <a class="hover-tooltip" href="/images/scantron.jpg" target="_blank" rel="noopener">scantron<img src="/images/scantron.jpg" alt="Scantron form"></a> forms with you at every class session***. You will be required to have a physical paper notebook (not an ipad or computer) for taking notes. Use of electronics (iphones, ipads, computers) is prohibited except when otherwise stated. The full list of what you need in the course can be found [here]({{ site.url }}/teaching/ecodyn156/syllabus/#requirements).
